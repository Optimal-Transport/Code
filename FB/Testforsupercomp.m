...
save('Results/jj5/FB-Temp.mat', 'temp_fb')
save('Results/jj5/FB-Obj.mat', 'obj_fb')
...
save('Results/jj5/FBbacktrack-Temp.mat', 'temp_fbb')
save('Results/jj5/FBbacktrack-Obj.mat', 'obj_fbb')
...
save('Results/jj5/Fista-Temp.mat', 'temp_fi')
save('Results/jj5/Fista-Obj.mat', 'obj_fi')
...
save('Results/jj5/Fistawbacktrack-Temp.mat', 'temp_fib')
save('Results/jj5/Fistawbacktrack-Obj.mat', 'obj_fib')
...
save('Results/jj5/Primaldual-Temp.mat', 'temp_pd')
save('Results/jj5/Primaldual-Obj.mat', 'obj_pd')
...
save('Results/jj5/Linearprog-Temp.mat', 'temp_lp')
save('Results/jj5/Linearprog-Obj.mat', 'sum(fval)')
...
save('Results/jj5/Entropicreg-Temp.mat', 'temp_er')
save('Results/jj5/Entropicreg-Obj.mat', 'obj_er')

save('Results/jj5/BarChart_temp.mat','temp')
save('Results/jj5/BarChart_finalobj.mat','obj')